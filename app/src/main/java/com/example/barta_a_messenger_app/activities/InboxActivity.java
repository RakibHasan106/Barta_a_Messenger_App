...
import com.example.barta_a_messenger_app.helpers.DBHelper;
...
import com.example.barta_a_messenger_app.adapters.ChatAdapter;
...
//                            Log.d("decrypted message type",message.getMessageType());
                            String decryptedMessage =
                                    (message.getMessageType().equals("pdf") && message.getMessageType().equals("doc"))?
                                            ...
                                            : message.getMessage();
                            Log.d("decrypted message inbox",decryptedMessage);

                            message.setMessage(decryptedMessage);

                        } catch (Exception e) {
                            Log.e("DECRYPTION in the inbox", "Failed to decrypt message: " + e.getMessage(), e);
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d("sendbuttonclicked","I am being clicked");
